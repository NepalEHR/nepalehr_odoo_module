from odoo import models,osv, fields, api, _, tools
from datetime import datetime, timedelta
from odoo.exceptions import ValidationError
class PurchaseReportCustomization(models.Model):
    _inherit = 'purchase.report'
    product_clasification = fields.Many2one('product.classification', 'Product Classification', readonly=True)
        ...
        self._cr.execute("""
            create view purchase_report as (
                ...
                select
                    ...
                    t.product_clasification as product_clasification,
                    s.currency_id,
                ...
                from purchase_order_line l
                    ...
                    join res_partner partner on s.partner_id = partner.id
                        left join product_product p on (l.product_id=p.id)
                            ...
                            LEFT join product_category pc ON (t.product_clasification = pc.id)
